...
if __name__ == '__main__':
    ...
    que.append('https://www.bbc.com/news/world-europe-56720589.amp')




    with open('int_urls.txt', 'w') as file:
        file.write('https://www.bbc.com/news/world-europe-56720589.amp' + '\n')
    ...
    with open('int_urls.txt', 'r') as file:
